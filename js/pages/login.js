...
export function renderLogin() {
    ...
    <div style="min-height: 100vh; display: flex; background: white;">
      ...
      <div style="display: none; flex-direction: column; align-items: center; justify-content: center; width: 45%; background: linear-gradient(160deg, var(--primary) 0%, var(--primary-dark) 100%); padding: 3rem; position: relative; overflow: hidden;" class="auth-brand-panel">
        ...
        <div style="position: relative; text-align: center; color: white;">
          ...
          <p style="font-size: 1.1rem; opacity: 0.85; line-height: 1.6; max-width: 280px;">Your intelligent travel companion for unforgettable journeys</p>
      ...
      <div style="flex: 1; display: flex; align-items: center; justify-content: center; padding: 2rem; background: #fff;">
        <div style="width: 100%; max-width: 400px;">
          ...
          <div style="margin-bottom: 2rem;">
            <h2 style="font-size: 1.75rem; font-weight: 700; color: var(--foreground); margin-bottom: 0.375rem;">Welcome back!</h2>
            <p style="font-size: 0.9rem; color: var(--muted-foreground);">Sign in to plan your next adventure</p>
          </div>

          <form id="loginForm" style="display: flex; flex-direction: column; gap: 1.125rem;" novalidate>
            ...
            <div style="display: flex; flex-direction: column; gap: 0.4rem;">
              ...
              <div style="position: relative;">
                <input type="password" id="password" placeholder="••••••••" style="height: 3rem; border-radius: var(--radius); padding-right: 2.5rem;" required>
            ...
            <button type="submit" class="btn btn-primary w-full" id="submitBtn" style="height: 3rem; border-radius: var(--radius); font-size: 1rem; font-weight: 700; letter-spacing: 0.3px;">Sign In</button>
          </form>
          ...
          <button id="googleLoginBtn" class="btn" style="width: 100%; height: 3rem; border: 1.5px solid var(--border); background: white; color: var(--foreground); display: flex; align-items: center; justify-content: center; gap: 0.75rem; border-radius: var(--radius); font-weight: 600;">
          ...
          <p style="text-align: center; font-size: 0.875rem; color: var(--muted-foreground); margin-top: 1.5rem;">
            ...
            <a href="/register" class="font-semibold" style="color: var(--primary); text-decoration: none;" id="registerLink">Sign Up</a>
          </p>
        </div>
      </div>
    </div>
  ...
  document.getElementById('togglePw').addEventListener('click', () => {
    ...
    document.getElementById('togglePw').innerHTML = isPassword ? getIcon('eyeOff') : getIcon('eye');
  });
